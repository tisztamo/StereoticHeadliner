    ...
    messages: [
      {
        role: 'system',
        content:
            `You are a crypto analyst and commentator creating short market summaries. Your style is catchy but not hyping.
           Sometimes you make witty hooks, other times you make more serious statements.
...
Make it very detailed, but concise.
`
      }
    ],
    max_tokens: 200,
